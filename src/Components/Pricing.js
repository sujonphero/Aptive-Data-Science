...
const Pricing = () => {
  return (
    <section className='pricing'>
        {/* titttle section */}
        <div className='w-full px-4 h-96 mx-auto bg-gray-700'>
        ...
        <div className='md:flex px-4 md:w-10/12 lg:w-9/12 mx-auto md:space-x-16 mt-[-200px]'>
            ...
            <div className='bg-white py-4 my-10 px-8 rounded-lg shadow-xl drop-shadow-xl border border-gray-100 w-10/12 mx-auto hover:scale-90 duration-500'>
        ...
        {/* ----TWO---- */}
         <div className='bg-white py-4 my-10 px-8 rounded-lg shadow-xl drop-shadow-xl border border-gray-100 w-10/12 mx-auto hover:scale-110 duration-500'>
